...
@implementation ECLocationTransform
...
- (id)initWithCLLocationCoordinate:(CLLocationCoordinate2D)coordinate2D{
    return [[ECLocationTransform alloc] initWithLatitude:coordinate2D.latitude andLongitude:coordinate2D.longitude];
}
